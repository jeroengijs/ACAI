...
%           file.
%           datatype = 2 (uint8), 4 (int16), 8 (int32), 16 (flota32), 
...
% history: added the use of pinfo (see spm_vol.m) from the reference
%          structure. If needed this has to be updated before calling this
%          routine.
%__________________________________________________________________________
% @(#)LCN12_write_image.m           v0.1          last modified: 2016/10/12
