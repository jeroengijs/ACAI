...
%
% Calculates Asymmetry Index (ACAI) and optionally GACAI using pre-existing
% CAT12 deformation fields. The PET, GM, and optional GMactivity images are
% expected in native space and will be warped to MNI for calculations.
%
% Input:
%   pet_image_native:
